...
QString MyApp::m_strUserName        = "xiao";
QString MyApp::m_strPassword        = "xiao";
...
void MyApp::ReadSettingFile()
{
    QSettings settings(m_strIniFile, QSettings::IniFormat);
    settings.beginGroup("UserCfg");
    m_strUserName = settings.value("User", "xiao").toString();
    m_strPassword = settings.value("Passwd", "xiao")  .toString();
    settings.endGroup();
